...
pnpm add @tanstack/react-query zustand axios react-native-mmkv react-native-keychain
pnpm add @notifee/react-native @react-native-firebase/app @react-native-firebase/messaging
...
| Dependencies conflict | Delete `node_modules` + `pnpm-lock.yaml`, re-install |
