 ...
 * - Kept: ALL SVG icons, DOM structure EXACTLY as Golden Standard
 * 
...
export default function LoginForm({
    ...
    return (
        <AuthLayout title={t('auth.welcome')} adminPrefix={adminPrefix}>
            {/* Login Card — auth.css: auth-glass (21px radius, responsive padding) */}
            <div key={`login-${locale}`} className="auth-glass">
                {/* Title — auth.css: auth-title (22px, weight 750, gradient) */}
                ...
                {/* Form — auth.css: auth-form (gap: 14px) */}
                <form onSubmit={handleSubmit} className="auth-form">
                    ...
                    <div>
                        <Input
                            ...
                            icon={LockIcon}
                        />
                        {/* Forgot Password — auth.css: auth-forgot-link (12.25px, 7px margin-top) */}
                    ...
                    {/* Submit Button — auth.css: auth-submit */}
                    <button
                        type="submit"
                        disabled={processing}
                ...
                {/* Divider — auth.css: auth-divider (21px margin) */}
                ...
                {/* Social Buttons — auth.css: auth-social-grid (10.5px gap) */}
