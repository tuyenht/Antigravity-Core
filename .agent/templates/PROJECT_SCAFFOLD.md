...
│   ├── roles/
│   │   └── AGENT_ROLES.md        ← 7 vai trò AI
│   ├── workflows/
│   │   ├── TEAM_WORKFLOW.md      ← Quy trình Input→Output
...
---
Generated by Antigravity-Core v3.0
```
...
- **Workflow pipeline:** `.agent/templates/WORKFLOW_PIPELINE.md`
